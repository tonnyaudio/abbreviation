...
if __name__ == '__main__':
    # write_line('./test.json', ['hello', 'I am', 'thw', 'again'])
    # print(regex_match(r'h(.*)o', 'hello world'))
    ...
    # print(find_all_hrefs('https://www.baidu.com/'))
    # print(translate('How are you'))  # no use
    # print(is_chinese_text('我是童翰文'))
    # str_list = ["how are you", 'hello', 'word']
    # freq_dict = {s: len(s) for s in str_list}
    # print(freq_dict_to_list(freq_dict))
    # csv_list = load_csv('test.json')
    # print(csv_list)

    # data = json.load(open('test.json', 'r'))
    # data.append({'context': 'where are you', 'question': 'who are you', 'ans': 'me'})
    # json.dump(data, open('test.json', 'w'))
    # data = json.load(open('test.json', 'r'))
    # print(len(data))
    # for line in load_list_generator('./demo.txt'):
    # 	print(line)
    # dict = load_dict('./demo.txt', sep=',')
    # print(dict)
